...
def main():
    ...
    my_cool_parser.add_argument("FileChooser", help=file_help_msg,
    ...
    # my_cool_parser.add_argument("FileSaver", help=file_help_msg,
    # widget="FileSaver")   # positional
    my_cool_parser.add_argument("MultiFileSaver", help=file_help_msg,
                                widget="MultiFileChooser")   # positional
    # my_cool_parser.add_argument("directory", help="Directory to store
    # output")          # positional
